...
{
    public class CategoryTopMainViewComponent : ViewComponent
    {
        ...
        public CategoryTopMainViewComponent(AppDBContext db, ICategoryServise categoryServise, CategoryConstantDisplayService categoryConstantDisplayService)
        {
            _db = db;
