...
namespace Jewelery.Migrations
{
    ...
    [Migration("20241219085337_Refactor_DetermineSize_And_add_DetermineSize_Object_v2")]
    partial class Refactor_DetermineSize_And_add_DetermineSize_Object_v2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jewelery.Models.Order_model.Delivery_detail", b =>
                {
                    ...
                    b.Property<bool>("StoreOrDoorDelivery")
                        .HasColumnType("bit");

                    b.Property<bool>("contactWithMe")
                        .HasColumnType("bit");

                    b.Property<string>("noteForOrder")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Jewelery.Models.Order_model.Order_detail", b =>
                {
                    ...
                    b.Property<string>("Product_Photo_URL")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Jewelery.Models.Product_model.DetermineTheSizeObject", b =>
                {
                    b.Property<int>("DetermineTheSizeObject_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DetermineTheSizeObject_Id"));
                    ...
                    b.HasKey("DetermineTheSizeObject_Id");

                    b.HasIndex("DetermineTheSize_Id");

                    b.ToTable("DetermineTheSizeObjects");
                });
            ...
            modelBuilder.Entity("Jewelery.Models.Review.FAQ", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jewelery.Models.Review.Fashion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jewelery.ViewModels.DTO.Order.Delivery_detailVMDTO", b =>
                {
                    b.Property<string>("Delivery_Father_Name")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Jewelery.ViewModels.DTO.Order.OrderVMDTO", b =>
                {
                    b.Property<DateTime>("Created_at")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Jewelery.ViewModels.DTO.Order_detail.Order_detailVMDTO", b =>
                {
                    b.Property<int>("Order_detail_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jewelery.ViewModels.DTO.Order_detail.Order_detail_optionVMDTO", b =>
                {
                    b.Property<string>("Atribute_Description")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Jewelery.Models.Product_model.DetermineTheSizeObject", b =>
                {
                    b.HasOne("Jewelery.Models.Product_model.DetermineTheSize", "DetermineTheSize")
                        .WithMany("determineTheSizeObjects")
                        .HasForeignKey("DetermineTheSize_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jewelery.Models.Product_model.DetermineTheSize", b =>
                {
                    b.Navigation("determineTheSizeObjects");
                });
